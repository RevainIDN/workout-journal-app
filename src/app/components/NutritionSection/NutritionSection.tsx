					...
					<div key={meal.id} className={nutritionStyles.mealSection}>
						<div className={nutritionStyles.mealHeader}>
							...
							<button className={nutritionStyles.mealDelete} onClick={() => deleteMeal(meal.id)}>
								<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FF00004D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
									<path d="M3 6h18"></path>
